...
//1236474/1109116/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OPA388IDGKR" (originalName "OPA388IDGKR")
	...
	(compDef "OPA388IDGKR" (originalName "OPA388IDGKR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA388IDGKR"))
		...
		(attr "Mouser Part Number" "595-OPA388IDGKR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/OPA388IDGKR?qs=HXFqYaX1Q2zq4dYzVXACyQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "OPA388IDGKR")
		(attr "Description" "10MHz, CMOS, Zero-Drift, Zero-Crossover, True RRIO Precision Operational Amplifier")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/opa388")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "OPA388IDGKR.stp")
